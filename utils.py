...
def base64d(b64_s):
	b64_bytes = b64_s if isinstance(b64_s, bytes) else utfencode(b64_s)
	bytes_s = b64decode(b64_bytes)
	s = utfdecode(bytes_s)
	return s


def base64e(s):
	bytes_s = s if not isinstance(s, bytes) else utfdecode(s)
	b64_bytes = b64encode(bytes_s)
	b64_s = utfencode(b64_bytes)
	return b64_s
